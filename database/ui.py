...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.save.setGeometry(QtCore.QRect(10, 110, 161, 25))
        self.save.setObjectName("save")
        self.load = QtWidgets.QPushButton(self.centralwidget)
        self.load.setGeometry(QtCore.QRect(180, 110, 181, 25))
        self.load.setObjectName("load")
        self.lineEdit = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEdit.setGeometry(QtCore.QRect(10, 240, 191, 25))
        self.lineEdit.setObjectName("lineEdit")
        self.find = QtWidgets.QPushButton(self.centralwidget)
        self.find.setGeometry(QtCore.QRect(10, 270, 71, 25))
        self.find.setObjectName("find")
        self.comboBox = QtWidgets.QComboBox(self.centralwidget)
        self.comboBox.setGeometry(QtCore.QRect(90, 270, 111, 25))
        self.comboBox.setObjectName("comboBox")
        self.word = QtWidgets.QLineEdit(self.centralwidget)
        self.word.setGeometry(QtCore.QRect(10, 160, 371, 31))
        self.word.setObjectName("word")
        self.change = QtWidgets.QPushButton(self.centralwidget)
        self.change.setGeometry(QtCore.QRect(250, 200, 89, 25))
        self.change.setObjectName("change")
        self.id = QtWidgets.QComboBox(self.centralwidget)
        self.id.setGeometry(QtCore.QRect(10, 200, 111, 25))
        self.id.setObjectName("id")
        self.pole = QtWidgets.QComboBox(self.centralwidget)
        self.pole.setGeometry(QtCore.QRect(130, 200, 111, 25))
        self.pole.setObjectName("pole")
        self.delete_2 = QtWidgets.QPushButton(self.centralwidget)
        self.delete_2.setGeometry(QtCore.QRect(10, 310, 71, 25))
        self.delete_2.setObjectName("delete_2")
        self.id_2 = QtWidgets.QComboBox(self.centralwidget)
        self.id_2.setGeometry(QtCore.QRect(90, 310, 111, 25))
        self.id_2.setObjectName("id_2")
        self.file_name = QtWidgets.QLineEdit(self.centralwidget)
        self.file_name.setGeometry(QtCore.QRect(10, 80, 331, 25))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEdit.setText(_translate("MainWindow", "что найти?"))
        self.find.setText(_translate("MainWindow", "Поиск"))
        self.word.setText(_translate("MainWindow", "введите на что хотите заменить выбранную запись"))
        self.change.setText(_translate("MainWindow", "Изменить"))
        self.delete_2.setText(_translate("MainWindow", "удалить"))
        self.file_name.setText(_translate("MainWindow", "введите имя файла (без .txt)"))
